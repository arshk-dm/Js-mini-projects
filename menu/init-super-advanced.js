...
// when you add sth dynamicly you can only access it after you introduce it into the dom
function displayMenuBtns() {
  const categories = menu.reduce(
    function (entireArray, arrayItem) {
      if (!entireArray.includes(arrayItem.category)) {
        entireArray.push(arrayItem.category);
      }
      return entireArray;
    },
    ["all"]
